...
Luft- und Raumfahrtingenieur mit Expertise in Industrie- und Forschungsprojekten von der Planung bis zur Fertigstellung. Erfahrener Dozent mit Expertise in der Durchführung von Seminaren und Betreuung von Studierenden aller Ebenen. Spezialisiert auf die Verbindung von klassischer Lenkung, Navigation und Regelung (GNC) mit Maschinellem Lernen (ML), mit Fokus auf Trajektorienvorhersage, Lenksysteme für Lenkflugkörper, Sensorfusion und autonome Systeme. Starker Hintergrund in mathematischer Modellierung, Simulation und Algorithmenentwicklung.
...
\jobtitle{Wissenschaftlicher Mitarbeiter / Promovend}{Aug. 2020 -- Juli 2026}{Institut für Flugmechanik und Flugregelung, Universität Stuttgart}{Stuttgart, Deutschland}{Forschungsschwerpunkt: Lenkung, Navigation \& Regelung und Maschinelles Lernen für Luft- und Raumfahrtanwendungen.}
...
\begin{itemize}[leftmargin=1.0cm]
    ...
    \item \textbf{Multi-Hypothesen-Lenkung für Lenkflugkörper} -- Berechnung von Lenkbefehlen unter Berücksichtigung mehrerer Hypothesen über das Zielverhalten (\textit{Wie lenkt man einen Flugkörper bei unsicheren Zielmanövern?})
\end{itemize}
...
\jobtitle{Wissenschaftliche Hilfskraft}{Sep. 2018 -- Nov. 2018}{Institut für Flugmechanik und Flugregelung, Universität Stuttgart}{Stuttgart, Deutschland}{Weiterentwicklung des DA40-Flugsimulators und Implementierung eines Hubschraubersimulationsmodells.}

% \vspace{-9pt}

\jobtitle{Wissenschaftliche Hilfskraft}{Mai 2018 -- Aug. 2018}{Institut für Flugmechanik und Flugregelung, Universität Stuttgart}{Stuttgart, Deutschland}{Tutor für Vorlesung „Flugregelungsentwurf": Verbesserung des Flugsimulators und Unterstützung bei Übungen.}


% \vspace{-9pt}

\jobtitle{Praktikant}{Apr. 2017 -- Aug. 2017}{MAHLE GmbH}{Stuttgart, Deutschland}{Auslegung von Thermalmanagementsystemen für Lithium-Ionen-Batterien. Analyse und Optimierung von Kühlsystemen.}
...
\degreeline{Masterarbeit}{2019 -- 2020}{Path Planning and Obstacle Avoidance for Multiple UAVs Using POMDP, \textit{Note: 1,0} \\ }{\qquad \qquad \qquad \qquad \qquad \quad \qquad \qquad \qquad \qquad \mbox{Queensland University of Technology, Brisbane, Australien}}
...
Versionskontrollsysteme (Git), Linux, SSH, VPS Deployment, Deep Learning Frameworks (PyTorch), Experiment Tracking (Weights \& Biases), Hyperparameter-Optimierung (Optuna), GitHub Copilot, Agentisches Programmieren
