...
\begin{itemize}
    ...
    \item \textbf{Grundkenntnisse:} SQL, Docker
\end{itemize}
...
Versionskontrollsysteme (Git), Linux, SSH, VPS Deployment, Deep Learning Frameworks (PyTorch), Experiment Tracking (Tensorboard), Hyperparameter-Optimierung (Optuna),  Datenbanken (SQLite), GitHub Copilot, Agentisches Programmieren
