...
Versionskontrollsysteme (Git), Linux, SSH, VPS Deployment, Deep Learning Frameworks (PyTorch), Experiment Tracking (Tensorboard), Hyperparameter-Optimierung (Optuna), GitHub Copilot, Agentisches Programmieren
